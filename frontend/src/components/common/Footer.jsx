...
import { BRAND_NAME, COMPANY_EMAIL, COMPANY_PHONE } from "../../constants/appConstants"
      ...
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-5 text-sm">
        ...
        <div>
          ...
          <p className="w-full md:w-2/3 text-gray-600 leading-6">
            {BRAND_NAME} is a trusted healthcare appointment booking platform that
            connects patients with qualified doctors. We make scheduling medical
            consultations simple, fast, and convenient, helping you access
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600 cursor-pointer">
            <li className=' hover:text-primary' onClick={()=>navigate('/')}> HOME</li>
            <li className=' hover:text-primary' onClick={()=>navigate('/about')}> ABOUT US</li>
            <li className=' hover:text-primary' onClick={()=>navigate('/contact')}> CONTACT US</li>
