...
export class AuthController {
  ...
  */
  ...
  signup = async (req, res) => {
    ...
    const { accessToken, accountInfo } = await this.authService.signup(name, email, password);
  ...
  signin = async (req, res) => {
    ...
    const { accessToken, accountInfo } = await this.authService.signin(email, password);
