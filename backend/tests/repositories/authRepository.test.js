...
describe('AuthRepository', () => {
  ...
  describe('isRegisterByEmail()', () => {
    it('should return true when account exists', async () => {
      ...
      const exists = await authRepository.isRegisterByEmail('john@example.com');
  ...
  describe('fetchAccountByEmail()', () => {
    ...
    it('should return mapped account', async () => {
      const account =
        await authRepository.fetchAccountByEmail('john@example.com');
  ...
  describe('fetchAccountById()', () => {
    ...
    it('should return mapped account', async () => {
      const account = await authRepository.fetchAccountById(createdAccount._id);
