...
describe('AuthController', () => {
  ...
  describe('signup()', () => {
    ...
    it('should propagate signup errors', async () => {
      ...
      await expect(authController.signup(req, res)).rejects.toThrow(error);
    });
  });
  ...
  describe('signin()', () => {
    ...
    it('should propagate signin errors', async () => {
      ...
      await expect(authController.signin(req, res)).rejects.toThrow(error);
    });
  });
  ...
  describe('accountInfo()', () => {
    it('should return account information', async () => {
      ...
      expect(authService.accountInfo).toHaveBeenCalledWith('123');
    ...
    it('should propagate accountInfo errors', async () => {
      ...
      await expect(authController.accountInfo(req, res)).rejects.toThrow(error);
    });
  });
});
